...
const FooterPage = () => {
  ...
  return (
    <div>
      <h2>Manage Footer</h2>
      <Button type="primary" onClick={handleEditFooter} style={{ marginBottom: 20 }}>
      ...
      {footer && (
        <>
          <Button type="primary" onClick={handleAddIcon} style={{ marginBottom: 20 }}>
            Add Icon
          </Button>
          <Table
      ...
      >
        <Form form={form} onFinish={handleFooterSubmit} layout="vertical">
          ...
          <Form.Item
            name="contentColor"
            label="Content Color"
            rules={[{ required: true, message: 'Please enter content color' }]}
          >
          ...
          <Form.Item
            name="contentSize"
            label="Content Size"
            rules={[{ required: true, message: 'Please enter content size' }]}
          >
